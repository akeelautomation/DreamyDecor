...
Monetag is installed on blog pages with the In-Page Push banner format only. Do not use MultiTag, browser Push Notifications, Onclick/Popunder, Direct Link/SmartLink, or service-worker ad formats. Setup and moderation notes are in `MONETAG_CLEAN_ADS.md`.
